#include <iostream>
// 如果include了iostream，会发现不用再include string也可以使用string，
...
int main()
{
    ...
    while (cin >> book)
    {
        cout << "ISBN、销售本书、原始价格、实售价格、折扣为 " << book << endl;
    }
    ...
    // {
    //     cout << "汇总信息：ISBN、销售本书、原始价格、实售价格、折扣为 "
    //               << trans1 + trans2 << endl;
    // }
    // else
    // {
    ...
    //         else
    //         {
    //             cout << "当前书籍的ISBN不同" << endl;
    //             break;
    //         }
    //     }
    //     cout << "有效汇总信息：ISBN、销售本书、原始价格、实售价格、折扣为 "
    //               << total << endl;
    // }
    // else
    // {
